...
<!--Code from Confirm order php-->				
            ...
            <li class="bold"><a href="../index.html" class="waves-effect waves-cyan"><i class="mdi-social-person"></i> Home</a></li>		
...
<button class="btn cyan waves-effect waves-light right" type="submit" name="action" <?php if($_POST['payment_type'] == 'cash on delivery')?>>Confirm Order
<i class="mdi-content-send right"></i>
  ...
  <footer class="page-footer">
    <div class="footer-copyright">
      <div class="container">
        <span>Copyright © 2017 <a class="grey-text text-lighten-4" href="#" target="_blank">Sawant</a> All rights reserved.</span>
